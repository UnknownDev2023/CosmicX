...
The `apeswap-frontend` repo is the primary frontend repository for [CosmicX.Finance](https://apeswap.finance), which is a multichain DeFi Hub offering an accessible, transparent, and secure experience for everyone.
...
Interested in learning more about CosmicX.Finance? Head over to our [official documentation](https://apeswap.gitbook.io/apeswap-finance/welcome/master) to read and learn more about our features, functionality, DAO, and ecosystem!
